...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO izin2 (jenis_izin, no_izin, masa_berlaku, ket, status, dok) VALUES (?, ?, ?, ?, ?, ?)");
...
<head>
    <meta charset="UTF-8" />
    <title>Tambah Data Izin PKS TERANTAM</title>
    <style>
        body {
...
<body>
    <h2>Tambah Data Izin PKS TERANTAM</h2>
    ...
    <a href="terantam_pks.php" class="back-link">&larr; Kembali ke Daftar Izin</a>
</body>
</html>
