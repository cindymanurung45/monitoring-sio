...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO izin5 (jenis_izin, no_izin, masa_berlaku, ket, status, dok) VALUES (?, ?, ?, ?, ?, ?)");
...
<head>
    <meta charset="UTF-8" />
    <title>Tambah Data Izin PPKO TANDUN</title>
    <style>
        body {
...
<body>
    <h2>Tambah Data Izin PPKO TANDUN</h2>
    ...
    <a href="ppkotandun_pks.php" class="back-link">&larr; Kembali ke Daftar Izin</a>
</body>
</html>
