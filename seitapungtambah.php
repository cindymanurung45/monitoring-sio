...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO izin3 (jenis_izin, no_izin, masa_berlaku, ket, status, dok) VALUES (?, ?, ?, ?, ?, ?)");
...
<head>
    <meta charset="UTF-8" />
    <title>Tambah Data Izin PKS TAPUNG</title>
    <style>
        body {
...
<body>
    <h2>Tambah Data Izin PKS TAPUNG</h2>
    ...
    <a href="seitapung_pks.php" class="back-link">&larr; Kembali ke Daftar Izin</a>
</body>
</html>
