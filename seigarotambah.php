...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO izin13 (jenis_izin, no_izin, masa_berlaku, ket, status, dok) VALUES (?, ?, ?, ?, ?, ?)");
...
<head>
    <meta charset="UTF-8" />
    <title>Tambah Data Izin PKS SEI GARO</title>
    <style>
        body {
...
<body>
    <h2>Tambah Data Izin PKS SEI GARO</h2>
    ...
    <a href="seigaro_pks.php" class="back-link">&larr; Kembali ke Daftar Izin</a>
</body>
</html>
