...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO izin (jenis_izin, no_izin, masa_berlaku, ket, status, dok) VALUES (?, ?, ?, ?, ?, ?)");
...
<head>
    <meta charset="UTF-8" />
    <title>Tambah Data Izin PKS SEI PAGAR</title>
    <style>
        body {
...
<body>
    <h2>Tambah Data Izin PKS SEI PAGAR</h2>
    ...
    <a href="seipagarpks.php" class="back-link">&larr; Kembali ke Daftar Izin</a>
</body>
</html>
