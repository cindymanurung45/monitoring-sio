...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO izin7 (jenis_izin, no_izin, masa_berlaku, ket, status, dok) VALUES (?, ?, ?, ?, ?, ?)");
...
<head>
    <meta charset="UTF-8" />
    <title>Tambah Data Izin PKS SEI BUATAN</title>
    <style>
        body {
...
<body>
    <h2>Tambah Data Izin PKS SEI BUATAN</h2>
    ...
    <a href="seibuatan_pks.php" class="back-link">&larr; Kembali ke Daftar Izin</a>
</body>
</html>
